...
export function HeroTile() {
  return (
    <div className="mx-auto w-full max-w-60 md:mx-0 md:max-w-70">
      <div
      ...
      >
        ...
        <span className="pointer-events-none absolute inset-0 grid place-items-center">
          <span className="h-[116%] w-[116%] animate-[spin_60s_linear_infinite] rounded-full border border-dashed border-primary/30" />
        </span>
        ...
        <span className="pointer-events-none absolute inset-0 grid place-items-center">
          <span className="relative h-[116%] w-[116%] animate-[spin_24s_linear_infinite]">
            <span
              ...
              style={{ boxShadow: "0 0 10px 2px color-mix(in srgb, var(--primary) 60%, transparent)" }}
            />
          </span>
        </span>
      </div>
